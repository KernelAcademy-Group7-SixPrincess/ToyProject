...
public interface ReviewBoardDao {
       ...
       int delete(BigInteger id, BigInteger user_id) throws Exception;// 특정 ID와 사용자 ID에 해당하는 게시글을 삭제


       int insert(ReviewBoardDto dto) throws Exception;  // 새로운 게시글을 삽입
       List<ReviewBoardDto> selectAll() throws Exception;// 모든 게시글을 조회
       ReviewBoardDto select(BigInteger id) throws Exception;// 특정 ID에 해당하는 게시글 하나를 조회
