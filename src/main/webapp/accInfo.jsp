...
<%
    String region = request.getParameter("id");
%>

<% if ("jeju".equals(region)) { %>
<div class="acc-card" onclick="location.href='/acc/jeju/1'">
    <img src="https://image.goodchoice.kr/resize_492x328/affiliate/2022/07/05/62c388d531a5f.jpg" alt="숙소 이미지"
         class="acc-thumb">
    <div class="acc-info">
        ...
        <p class="acc-price">
            <del>350,000원</del>
            → <strong>60,000원</strong></p>
    </div>
</div>

<div class="acc-card" onclick="location.href='/acc/jeju/2'">
    <img src="https://image.goodchoice.kr/resize_792x480/affiliate/2025/06/04/684009ead7eab.jpg" alt="숙소 이미지"
         class="acc-thumb">
    <div class="acc-info">
        ...
        <p class="acc-price">
            <del>169,000원</del>
            → <strong>158,860원</strong></p>
    </div>
</div>
<% } else if ("seoul".equals(region)) { %>
<div class="acc-card" onclick="location.href='/acc/seoul/1'">
    <img src="https://image.goodchoice.kr/resize_792x480/adimg_new/895/215496/e9e6c915d863b2f30d51805c2e81cc81.jpg"
         alt="숙소 이미지" class="acc-thumb">
    <div class="acc-info">
...
<div class="acc-card" onclick="location.href='/acc/seoul/2'">
    <img src="https://image.goodchoice.kr/resize_792x480/adimg_new/49461/8046/17a48e6759fbbd5e0db7f5195d52db07.jpg"
         alt="숙소 이미지" class="acc-thumb">
    <div class="acc-info">
