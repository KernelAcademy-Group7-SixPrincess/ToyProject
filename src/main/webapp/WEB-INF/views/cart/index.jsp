    ...
    <form id="cartForm" aria-labelledby="cart-title">
        ...
        <section class="cart-list" aria-label="장바구니 목록" role="list">
            <article class="cart-item" role="listitem">
                ...
                <a href="/pages/jeju-detail.html" class="item-thumb-wrapper" aria-label="신화관 제주신화월드 호텔앤리조트 상세보기">
                    <img
                            class="item-thumb"
                ...
                <div class="item-content">
                    ...
                    <header class="item-info">
                        ...
                        <h3 class="item-name"><a href="/pages/jeju-detail.html" tabindex="0">신화관 제주신화월드 호텔앤리조트</a></h3>
            ...
            <article class="cart-item" role="listitem">
                ...
                <a href="/pages/jeju-detail.html" class="item-thumb-wrapper" aria-label="랜딩관 제주신화월드 호텔앤리조트 상세보기">
                    <img
                            class="item-thumb"
                ...
                <div class="item-content">
                    ...
                    <header class="item-info">
                        <p class="item-category">블랙 · 5성급 · 호텔</p>
                        <h3 class="item-name"><a href="/pages/jeju-detail.html" tabindex="0">랜딩관 제주신화월드 호텔앤리조트</a></h3>
                        <p class="item-location">
                            <span class="item-region">서귀포시</span>
                            <span class="item-location-detail">신화테마파크 & 신화워터파크 도보 3분</span>
                        </p>
            ...
            <article class="cart-item" role="listitem">
                ...
                <a href="/pages/jeju-detail.html" class="item-thumb-wrapper" aria-label="제주호텔더엠 상세보기">
                ...
                <div class="item-content">
                    ...
                    <header class="item-info">
                        ...
                        <h3 class="item-name"><a href="/pages/jeju-detail.html" tabindex="0">제주호텔더엠</a></h3>
                        <p class="item-location">
                            <span class="item-region">서귀포시</span>
